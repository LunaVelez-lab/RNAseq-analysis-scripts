...
data = read.table('/scratch/yquint/ZEB_project/SLAM-seq/GRAND-SLAM/20230614_deseq2/Total_RNA_results/DE_totalRNA_results_all_unique_shrink.txt', sep = "\t", stringsAsFactors = F, header = TRUE)
